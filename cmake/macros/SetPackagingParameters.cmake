...
macro(SET_PACKAGING_PARAMETERS)
  ...
  set(BUILD_NUMBER 0)
  set(APP_USER_MODEL_ID "com.isekaivr.console-dev")
  ...
  if (RELEASE_TYPE STREQUAL "PRODUCTION")
    ...
    set(BUILD_ORGANIZATION "IsekaiVR")
  ...
  elseif (RELEASE_TYPE STREQUAL "PR")
    ...
    set(BUILD_ORGANIZATION "IsekaiVR - PR${RELEASE_NUMBER}")
    set(INTERFACE_BUNDLE_NAME "Interface")
    ...
    set(BUILD_ORGANIZATION "IsekaiVR - ${BUILD_VERSION}")
    set(INTERFACE_BUNDLE_NAME "Interface")
    set(INTERFACE_ICON_PREFIX "interface-beta")
  ...
  if (WIN32)
    ...
    # shortcut names
    if (PRODUCTION_BUILD)
      set(INTERFACE_SHORTCUT_NAME "IsekaiVR Interface")
      set(CONSOLE_SHORTCUT_NAME "Console")
      set(SANDBOX_SHORTCUT_NAME "Sandbox")
      set(APP_USER_MODEL_ID "com.isekaivr.console")
    else ()
      set(INTERFACE_SHORTCUT_NAME "IsekaiVR Interface - ${BUILD_VERSION_NO_SHA}")
    ...
    set(CONSOLE_HF_SHORTCUT_NAME "IsekaiVR ${CONSOLE_SHORTCUT_NAME}")
    set(SANDBOX_HF_SHORTCUT_NAME "IsekaiVR ${SANDBOX_SHORTCUT_NAME}")
	
    set(PRE_SANDBOX_INTERFACE_SHORTCUT_NAME "IsekaiVR")
