...
macro(GENERATE_INSTALLERS)
  ...
  if (CLIENT_ONLY)
    ...
    string(REGEX REPLACE "IsekaiVR" "IsekaiVR Interface" _DISPLAY_NAME ${BUILD_ORGANIZATION})
  elseif (SERVER_ONLY)
    set(_PACKAGE_NAME_EXTRA "-Sandbox")
    set(INSTALLER_TYPE "server_only")
    string(REGEX REPLACE "IsekaiVR" "IsekaiVR Sandbox" _DISPLAY_NAME ${BUILD_ORGANIZATION})
  else ()
  ...
  set(CPACK_PACKAGE_VENDOR "IsekaiVR")
  set(CPACK_PACKAGE_VERSION ${BUILD_VERSION})
  set(CPACK_PACKAGE_FILE_NAME "IsekaiVR-Beta${_PACKAGE_NAME_EXTRA}-${BUILD_VERSION}")
  ...
  if (BUILD_CLIENT)
    cpack_add_component(${CLIENT_COMPONENT} DISPLAY_NAME "IsekaiVR Interface")
  endif ()

  if (BUILD_SERVER)
    cpack_add_component(${SERVER_COMPONENT} DISPLAY_NAME "IsekaiVR Sandbox")
  endif ()
